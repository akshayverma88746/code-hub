            ...
            <nav>
                ...
                <div>
                    <ul id="navbar">
                        ...
                        <li>
                            {/* <Link to="/webdev">Web-Editor</Link> */}
                            <NavLink activeClassName="menu-active" exact className="nav-link" to="/webdev">Web-Editor</NavLink>
                        </li>
                        <li>
                            {/* <Link to="/ceditor">Code-Editor</Link> */}
                            <NavLink activeClassName="menu-active" exact className="nav-link" to="/ceditor">Code-Editor</NavLink>
                        </li>
                    </ul>
                </div>
            </nav>
